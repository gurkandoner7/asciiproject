...
import com.portal.asciiproject.utilities.CustomTypefaceSpan
...
/*fun getBitmapDescriptorFromVectorRes(
    context: Context,
...
/*
fun Fragment.showLoadingDialog(shouldShow: Boolean) {
    if (shouldShow && !isLoadingDialogShowing) {
        isLoadingDialogShowing = true
        LoadingDialogFragment.newInstance().show(childFragmentManager, "LOADING")
    } else if (!shouldShow && isLoadingDialogShowing) {
        isLoadingDialogShowing = false
        val loadingDialogFragment = childFragmentManager.findFragmentByTag("LOADING") as? LoadingDialogFragment
