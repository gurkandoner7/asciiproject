...
class HomeViewModel @Inject constructor() : ViewModel() {
    ...
    init {
        val sampleProducts = listOf(
            ...
            ProductItem("Coffee", "Espresso", "Chocolate", "$2.49", "per cup", R.drawable.coffee1),
            ProductItem("Coffee", "Mocha", "Almond Milk", "$3.49", "per cup", R.drawable.coffee2),
            ProductItem("Coffee", "Cappuccino", "Oat Milk", "$2.99", "per cup", R.drawable.coffee10),
            ...
            ProductItem("Coffee", "Americano", "Cashew Milk", "$2.99", "per cup", R.drawable.coffee1),
            ...
            ProductItem("Coffee", "Espresso", "Soy Milk", "$2.49", "per cup", R.drawable.coffee5),
            ...
            ProductItem("Coffee", "Espresso", "Hazelnut Milk", "$2.49", "per cup", R.drawable.coffee9),
            ...
            ProductItem("Coffee", "Espresso", "Almond Milk", "$2.49", "per cup", R.drawable.coffee3),
            ProductItem("Coffee", "Latte", "Hazelnut Milk", "$3.99", "per cup", R.drawable.coffee1),
            ProductItem("Coffee", "Macchiato", "Coconut Milk", "$3.29", "per cup", R.drawable.coffee4),
            ProductItem("Coffee", "Americano", "Cashew Milk", "$2.99", "per cup", R.drawable.coffee8),
            ProductItem("Coffee", "Flat White", "Soy Milk", "$3.49", "per cup", R.drawable.coffee2),
            ProductItem("Coffee", "Espresso", "Oat Milk", "$2.49", "per cup", R.drawable.coffee2),
            ProductItem("Coffee", "Latte", "Almond Milk", "$3.99", "per cup", R.drawable.coffee1),
            ProductItem("Coffee", "Macchiato", "Hazelnut Milk", "$3.29", "per cup", R.drawable.coffee4),
            ProductItem("Coffee", "Americano", "Coconut Milk", "$2.99", "per cup", R.drawable.coffee9),
            ProductItem("Coffee", "Flat White", "Cashew Milk", "$3.49", "per cup", R.drawable.coffee2),
            ProductItem("Coffee", "Espresso", "Soy Milk", "$2.49", "per cup", R.drawable.coffee7),
